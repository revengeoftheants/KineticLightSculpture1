...
THREE.ShaderExtras = {
	...
	//  What is convolution ? Simply speaking convolution is weighted sum of 
	//  pixel values around target pixel. If those weights are put into vector W 
	//  and pixel values around x,y are put in vector P, then in linear algebra 
	//  terms convolution at x,y is nothing more than dot product of vectors W,P.
	//  This W vector is called kernel. So by using different kernels we could 
	//  achieve different image convolution effects. Several common convolution
	//  kernels: gaussian blur, sharpness, edge detection, and emboss.
	//
	...
	/* -------------------------------------------------------------------------
	//	Dot screen shader (like Ben-Day dots)
	//  - based on glfx.js sepia shader
	//		https://github.com/evanw/glfx.js
	// 
	//  Great example: http://www.airtightinteractive.com/2013/02/intro-to-pixel-shaders-in-three-js/
	 ------------------------------------------------------------------------- */
	...
	//
	//  This causes the scene to shade off gradually into black.
	 ------------------------------------------------------------------------------------------------ */
	...
	/* -------------------------------------------------------------------------
	//	Triangle blur shader  (this is a type of smoothing)
